...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6 fs-2 d-flex m-auto flex-wrap">
                <p class="">Dankjewel voor je bestelling van: </p>
                <p class="m-auto">Uw ontvangt een email van ons als wij uw bestelling versturen.</p>
            </div>
