...
session_start();
$boeken = [];
$results = curl_init('https://www.googleapis.com/books/v1/volumes?q=a&maxResults=40');
...
<body>
    <form action="POST">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <a href="index.php"></a><img src="logo-boekland.png" alt="logo-boekland.png" width="155px" height="80px">
                </div>
            ...
            <div class="text-center text-lg-start">
                <h2 class="text-center mt-5">Ons asortiment</h2>
                <div class="row pt-4 gy-3">
                    ...
                    foreach ($boeken["items"] as $boek) {
                        ?>
                        <div class="col-3">
                            <div class="card fs-5 mb-2 h-100">
                                <div class="card-body">
